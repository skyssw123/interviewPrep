...
public class StampDispenser_ver1
{
    /**
     ...
     */
	Integer[] typeStamps;
    public StampDispenser_ver1(int[] stampDenominations)
    {
    ...
    public int calcMinNumStampsToFillRequest(int request)
    {
    	...
    	return calMinNumStamps(request);
    }
    ...
    public static void main(String[] args)
    {
        ...
        StampDispenser_ver1 stampDispenser = new StampDispenser_ver1(denominations);
