...
public class StampDispenser_ver2
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        StampDispenser_ver2 stampDispenser = new StampDispenser_ver2(denominations);
