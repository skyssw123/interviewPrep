...
public class Main {
	public static class BusinessInfo implements Comparable<BusinessInfo>
	{
		...
		{
			if(this.rating < 1 || this.rating > 5)   // return value 1 : {..., other, this, ...}
				return 1;
			
			else if(other.rating < 1 || other.rating > 5) // return value -1: { ..., this, other, ...}
				return -1;
			...
			if(this.rating == other.rating)
				...
				return 1;						//return value 1 indicates that other precedes this in sorted array (  { .., other, this, ...})
			else // if(this.rating > other.rating) 
				return -1;						//return value -1 indicates that this precedes other in sorted array ( {..., this, other, ...})
		}
	}
