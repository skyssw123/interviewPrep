...
public class Main {
	...
	public static class Pet
	{
		public static class Builder
		{
			...
			private Integer ownerAge = 3; //default value
	...
	public static void main(String[] args) {
		...
		//Static class initialization creates a new instance of the static class..
		...
		System.out.println(a.animalAge);
		System.out.println(a.ownerAge);
	}
